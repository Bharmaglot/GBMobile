...
internal class MainController : BaseController
{
    ...
    private GoToMainMenuController _goToMainMenuController;
    ...
    private void OnChangeGameState(GameState state)
    {
        ...
        switch (state)
        {
            ...
            case GameState.Game:
                ...
                _goToMainMenuController = new GoToMainMenuController(_placeForUi, _profilePlayer);
                break;
    ...
    private void DisposeChildObjects()
    {
        ...
        _goToMainMenuController?.Dispose();
